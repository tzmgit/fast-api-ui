...
from fast_api_ui.app import create_app
from fast_api_ui.database import db
from fast_api_ui.settings import DevConfig, ProdConfig
from fast_api_ui.user.models import User

CONFIG = ProdConfig if os.environ.get('FAST_API_UI_ENV') == 'prod' else DevConfig
